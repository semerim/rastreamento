...
<?php
   ...
   $qs_redirect = "visao_fs.php?consulta=localidades";
...
// carrega os campos do registro
   ...
   $campos[2][0] = "IP_SERVIDORES";
   $campos[2][1] = "ip_servidores";
   ...
   // define ("EDIT_COD_RASTREAMENTO", montaEdit ("mostra_NRO_DOC_COMERCIAL", $nro_doc_comercial, 10, "text", "0", $novo, $nro_doc_comercial));
	...
	define ("EDIT_IP_SERVIDORES", montaEdit ("grava_IP_SERVIDORES", IP_SERVIDORES, 150, "", $edicao, $novo, ""));
...
<table width="100%"  border="0" bordercolor="#CCCCCC">
  ...
  <tr>
    <td class="tabela1Fixo"<div align="right">IPs dos Servidores:</div></td>
    <td align="left" valign="middle" class="tabela2Fixo">
    	 <?php echo EDIT_IP_SERVIDORES ?>
    </td>
  </tr>
</table>
<center>
